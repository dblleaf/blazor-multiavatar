namespace BlazorMultiavatar
{
    ...
    public class MultiAvatarBuilder
    {
        ...
        private const string Str = "stroke-linecap:round;stroke-linejoin:round;stroke-width:";

        #region Themes

        private static Dictionary<string, Dictionary<string, Dictionary<string, string[]>>> Themes =>
            new Dictionary<string, Dictionary<string, Dictionary<string, string[]>>>()
            {
                // Robo
                {
                    "00", new Dictionary<string, Dictionary<string, string[]>>
                    {
                        {
                            "A", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#ff2f2b" } },
                                { "clo", new string[] { "#fff", "#000" } },
                                { "head", new string[] { "#fff" } },
                                { "mouth", new string[] { "#fff", "#000", "#000" } },
                                { "eyes", new string[] { "#000", "none", "#00FFFF" } },
                                { "top", new string[] { "#fff", "#fff" } },
                            }
                        },
                        {
                            "B", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#ff1ec1" } },
                                { "clo", new string[] { "#000", "#fff" } },
                                { "head", new string[] { "#ffc1c1" } },
                                { "mouth", new string[] { "#fff", "#000", "#000" } },
                                { "eyes", new string[] { "#FF2D00", "#fff", "none" } },
                                { "top", new string[] { "#a21d00", "#fff" } },
                            }
                        },
                        {
                            "C", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#0079b1" } },
                                { "clo", new string[] { "#0e00b1", "#d1fffe" } },
                                { "head", new string[] { "#f5aa77" } },
                                { "mouth", new string[] { "#fff", "#000", "#000" } },
                                { "eyes", new string[] { "#0c00de", "#fff", "none" } },
                                { "top", new string[] { "#acfffd", "#acfffd" } },
                            }
                        },
                    }
                },
                ...
                // Girl
                {
                    "01", new Dictionary<string, Dictionary<string, string[]>>
                    {
                        {
                            "A", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#a50000" } },
                                { "clo", new string[] { "#f06", "#8e0039" } },
                                { "head", new string[] { "#85492C" } },
                                { "mouth", new string[] { "#000" } },
                                { "eyes", new string[] { "#000", "#ff9809" } },
                                { "top", new string[] { "#ff9809", "#ff9809", "none", "none" } },
                            }
                        },
                        {
                            "B", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#40E83B" } },
                                { "clo", new string[] { "#00650b", "#62ce5a" } },
                                { "head", new string[] { "#f7c1a6" } },
                                { "mouth", new string[] { "#6e1c1c" } },
                                { "eyes", new string[] { "#000", "#ff833b" } },
                                { "top", new string[] { "#67FFCC", "none", "none", "#ecff3b" } },
                            }
                        },
                        {
                            "C", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#ff2c2c" } },
                                { "clo", new string[] { "#fff", "#000" } },
                                { "head", new string[] { "#ffce8b" } },
                                { "mouth", new string[] { "#000" } },
                                { "eyes", new string[] { "#000", "#0072ff" } },
                                { "top", new string[] { "#ff9809", "none", "#ffc809", "none" } },
                            }
                        },
                    }
                },
                ...
                // Blonde
                {
                    "02", new Dictionary<string, Dictionary<string, string[]>>
                    {
                        {
                            "A", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#ff7520" } },
                                { "clo", new string[] { "#d12823" } },
                                { "head", new string[] { "#fee3c5" } },
                                { "mouth", new string[] { "#d12823" } },
                                { "eyes", new string[] { "#000", "none" } },
                                { "top", new string[] { "#000", "none", "none",  "#FFCC00", "red" } },
                            }
                        },
                        {
                            "B", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#ff9700" } },
                                { "clo", new string[] { "#000" } },
                                { "head", new string[] { "#d2ad6d" } },
                                { "mouth", new string[] { "#000" } },
                                { "eyes", new string[] { "#000", "#00ffdc" } },
                                { "top", new string[] { "#fdff00", "#fdff00", "none", "none", "none" } },
                            }
                        },
                        {
                            "C", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#26a7ff" } },
                                { "clo", new string[] { "#d85cd7" } },
                                { "head", new string[] { "#542e02" } },
                                { "mouth", new string[] { "#f70014" } },
                                { "eyes", new string[] { "#000", "magenta" } },
                                { "top", new string[] { "#FFCC00", "#FFCC00", "#FFCC00", "#ff0000", "yellow" } },
                            }
                        },
                    }
                },
                ...
                // Evilnormie
                {
                    "03", new Dictionary<string, Dictionary<string, string[]>>
                    {
                        {
                            "A", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#6FC30E" } },
                                { "clo", new string[] { "#b4e1fa", "#5b5d6e", "#515262", "#a0d2f0", "#a0d2f0" } },
                                { "head", new string[] { "#fae3b9" } },
                                { "mouth", new string[] { "#fff", "#000" } },
                                { "eyes", new string[] { "#000" } },
                                { "top", new string[] { "#8eff45", "#8eff45", "none", "none" } },
                            }
                        },
                        {
                            "B", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#00a58c" } },
                                { "clo", new string[] { "#000", "#5b00", "#5100", "#a000", "#a000" } },
                                { "head", new string[] { "#FAD2B9" } },
                                { "mouth", new string[] { "#fff", "#000" } },
                                { "eyes", new string[] { "#000" } },
                                { "top", new string[] { "#FFC600", "none", "#FFC600", "none" } },
                            }
                        },
                        {
                            "C", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#ff501f" } },
                                { "clo", new string[] { "#000", "#ff0000", "#ff0000", "#7d7d7d", "#7d7d7d" } },
                                { "head", new string[] { "#fff3dc" } },
                                { "mouth", new string[] { "#d2001b", "none" } },
                                { "eyes", new string[] { "#000" } },
                                { "top", new string[] { "#D2001B", "none", "none", "#D2001B" } },
                            }
                        },
                    }
                },
                ...
                // Country
                {
                    "04", new Dictionary<string, Dictionary<string, string[]>>
                    {
                        {
                            "A", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#fc0" } },
                                { "clo", new string[] { "#901e0e", "#ffbe1e", "#ffbe1e", "#c55f54" } },
                                { "head", new string[] { "#f8d9ad" } },
                                { "mouth", new string[] { "#000", "none", "#000", "none" } },
                                { "eyes", new string[] { "#000" } },
                                { "top", new string[] { "#583D00", "#AF892E", "#462D00", "#a0a0a0" } },
                            }
                        },
                        {
                            "B", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#386465" } },
                                { "clo", new string[] { "#fff", "#333", "#333", "#333" } },
                                { "head", new string[] { "#FFD79D" } },
                                { "mouth", new string[] { "#000", "#000", "#000", "#000" } },
                                { "eyes", new string[] { "#000" } },
                                { "top", new string[] { "#27363C", "#5DCAD4", "#314652", "#333" } },
                            }
                        },
                        {
                            "C", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#DFFF00" } },
                                { "clo", new string[] { "#304267", "#aab0b1", "#aab0b1", "#aab0b1" } },
                                { "head", new string[] { "#e6b876" } },
                                { "mouth", new string[] { "#50230a", "#50230a", "#50230a", "#50230a" } },
                                { "eyes", new string[] { "#000" } },
                                { "top", new string[] { "#333", "#afafaf", "#222", "#6d3a1d" } },
                            }
                        },
                    }
                },
                ...
                // Johnyold
                {
                    "05", new Dictionary<string, Dictionary<string, string[]>>
                    {
                        {
                            "A", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#a09300" } },
                                { "clo", new string[] { "#c7d4e2", "#435363", "#435363", "#141720", "#141720", "#e7ecf2", "#e7ecf2" } },
                                { "head", new string[] { "#f5d4a6" } },
                                { "mouth", new string[] { "#000", "#cf9f76" } },
                                { "eyes", new string[] { "#000", "#000", "#000", "#000", "#000", "#000", "#fff", "#fff", "#fff", "#fff", "#000", "#000" } },
                                { "top", new string[] { "none", "#fdff00" } },
                            }
                        },
                        {
                            "B", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#b3003e" } },
                                { "clo", new string[] { "#000", "#435363", "#435363", "#000", "none", "#e7ecf2", "#e7ecf2" } },
                                { "head", new string[] { "#f5d4a6" } },
                                { "mouth", new string[] { "#000", "#af9f94" } },
                                { "eyes", new string[] { "#9ff3ffdb", "#000", "#9ff3ffdb", "#000", "#2f508a", "#000", "#000", "#000", "none", "none", "none", "none" } },
                                { "top", new string[] { "#ff9a00", "#ff9a00" } },
                            }
                        },
                        {
                            "C", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#884f00" } },
                                { "clo", new string[] { "#ff0000", "#fff", "#fff", "#141720", "#141720", "#e7ecf2", "#e7ecf2" } },
                                { "head", new string[] { "#c57b14" } },
                                { "mouth", new string[] { "#000", "#cf9f76" } },
                                { "eyes", new string[] { "none", "#000", "none", "#000", "#5a0000", "#000", "#000", "#000", "none", "none", "none", "none" } },
                                { "top", new string[] { "#efefef", "none" } },
                            }
                        },
                    }
                },
                ...
                // Asian
                {
                    "06", new Dictionary<string, Dictionary<string, string[]>>
                    {
                        {
                            "A", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#8acf00" } },
                                { "clo", new string[] { "#ee2829", "#ff0" } },
                                { "head", new string[] { "#ffce73" } },
                                { "mouth", new string[] { "#fff", "#000" } },
                                { "eyes", new string[] { "#000" } },
                                { "top", new string[] { "#000", "#000", "none", "#000", "#ff4e4e", "#000" } },
                            }
                        },
                        {
                            "B", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#00d2a3" } },
                                { "clo", new string[] { "#0D0046", "#ffce73" } },
                                { "head", new string[] { "#ffce73" } },
                                { "mouth", new string[] { "#000", "none" } },
                                { "eyes", new string[] { "#000" } },
                                { "top", new string[] { "#000", "#000", "#000", "none", "#ffb358",  "#000", "none", "none" } },
                            }
                        },
                        {
                            "C", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#ff184e" } },
                                { "clo", new string[] { "#000", "none" } },
                                { "head", new string[] { "#ffce73" } },
                                { "mouth", new string[] { "#ff0000", "none" } },
                                { "eyes", new string[] { "#000" } },
                                { "top", new string[] { "none", "none", "none", "none", "none",  "#ffc107", "none", "none" } },
                            }
                        },
                    }
                },
                ...
                // Punk
                {
                    "07", new Dictionary<string, Dictionary<string, string[]>>
                    {
                        {
                            "A", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#00deae" } },
                                { "clo", new string[] { "#ff0000" } },
                                { "head", new string[] { "#ffce94" } },
                                { "mouth", new string[] { "#f73b6c", "#000" } },
                                { "eyes", new string[] { "#e91e63", "#000", "#e91e63", "#000", "#000", "#000" } },
                                { "top", new string[] { "#dd104f", "#dd104f", "#f73b6c", "#dd104f" } },
                            }
                        },
                        {
                            "B", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#181284" } },
                                { "clo", new string[] { "#491f49", "#ff9809", "#491f49" } },
                                { "head", new string[] { "#f6ba97" } },
                                { "mouth", new string[] { "#ff9809", "#000" } },
                                { "eyes", new string[] { "#c4ffe4", "#000", "#c4ffe4", "#000", "#000", "#000" } },
                                { "top", new string[] { "none", "none", "#d6f740", "#516303" } },
                            }
                        },
                        {
                            "C", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#bcf700" } },
                                { "clo", new string[] { "#ff14e4", "#000", "#14fffd" } },
                                { "head", new string[] { "#7b401e" } },
                                { "mouth", new string[] { "#666", "#000" } },
                                { "eyes", new string[] { "#00b5b4", "#000", "#00b5b4", "#000", "#000", "#000" } },
                                { "top", new string[] { "#14fffd", "#14fffd", "#14fffd", "#0d3a62" } },
                            }
                        },
                    }
                },
                ...
                // Afrohair
                {
                    "08", new Dictionary<string, Dictionary<string, string[]>>
                    {
                        {
                            "A", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#0df" } },
                                { "clo", new string[] { "#571e57", "#ff0" } },
                                { "head", new string[] { "#f2c280" } },
                                { "mouth", new string[] { "#ff0000" } },
                                { "eyes", new string[] { "#795548", "#000" } },
                                { "top", new string[] { "#de3b00", "none" } },
                            }
                        },
                        {
                            "B", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#B400C2" } },
                                { "clo", new string[] { "#0D204A", "#00ffdf" } },
                                { "head", new string[] { "#ca8628" } },
                                { "mouth", new string[] { "#1a1a1a" } },
                                { "eyes", new string[] { "#cbbdaf", "#000" } },
                                { "top", new string[] { "#000", "#000" } },
                            }
                        },
                        {
                            "C", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#ffe926" } },
                                { "clo", new string[] { "#00d6af", "#000" } },
                                { "head", new string[] { "#8c5100" } },
                                { "mouth", new string[] { "#7d0000" } },
                                { "eyes", new string[] { "none", "#000" } },
                                { "top", new string[] { "#f7f7f7", "none" } },
                            }
                        },
                    }
                },
                ...
                // Normie female
                {
                    "09", new Dictionary<string, Dictionary<string, string[]>>
                    {
                        {
                            "A", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#4aff0c" } },
                                { "clo", new string[] { "#101010", "#fff", "#fff" } },
                                { "head", new string[] { "#dbbc7f" } },
                                { "mouth", new string[] { "#000" } },
                                { "eyes", new string[] { "#000", "none", "none" } },
                                { "top", new string[] { "#531148", "#531148", "#531148", "none" } },
                            }
                        },
                        {
                            "B", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#FFC107" } },
                                { "clo", new string[] { "#033c58", "#fff", "#fff" } },
                                { "head", new string[] { "#dbc97f" } },
                                { "mouth", new string[] { "#000" } },
                                { "eyes", new string[] { "none", "#fff", "#000" } },
                                { "top", new string[] { "#FFEB3B", "#FFEB3B", "none", "#FFEB3B" } },
                            }
                        },
                        {
                            "C", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#FF9800" } },
                                { "clo", new string[] { "#b40000", "#fff", "#fff" } },
                                { "head", new string[] { "#E2AF6B" } },
                                { "mouth", new string[] { "#000" } },
                                { "eyes", new string[] { "none", "#fff", "#000" } },
                                { "top", new string[] { "#ec0000", "#ec0000", "none", "none" } },
                            }
                        },
                    }
                },
                ...
                // Older
                {
                    "10", new Dictionary<string, Dictionary<string, string[]>>
                    {
                        {
                            "A", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#104c8c" } },
                                { "clo", new string[] { "#354B65", "#3D8EBB", "#89D0DA", "#00FFFD" } },
                                { "head", new string[] { "#cc9a5c" } },
                                { "mouth", new string[] { "#222", "#fff" } },
                                { "eyes", new string[] { "#000", "#000" } },
                                { "top", new string[] { "#fff", "#fff", "none" } },
                            }
                        },
                        {
                            "B", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#0DC15C" } },
                                { "clo", new string[] { "#212121", "#fff", "#212121", "#fff", } },
                                { "head", new string[] { "#dca45f" } },
                                { "mouth", new string[] { "#111", "#633b1d" } },
                                { "eyes", new string[] { "#000", "#000" } },
                                { "top", new string[] { "none", "#792B74", "#792B74" } },
                            }
                        },
                        {
                            "C", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#ffe500" } },
                                { "clo", new string[] { "#1e5e80", "#fff", "#1e5e80", "#fff" } },
                                { "head", new string[] { "#e8bc86" } },
                                { "mouth", new string[] { "#111", "none" } },
                                { "eyes", new string[] { "#000", "#000" } },
                                { "top", new string[] { "none", "none", "#633b1d" } },
                            }
                        },
                    }
                },
                    ...
                    {
                        {
                            "A", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#4a3f73" } },
                                { "clo", new string[] { "#e6e9ee", "#f1543f", "#ff7058", "#fff", "#fff" } },
                                { "head", new string[] { "#b27e5b" } },
                                { "mouth", new string[] { "#191919", "#191919" } },
                                { "eyes", new string[] { "#000", "#000", "#57FFFD" } },
                                { "top", new string[] { "#ffc", "#ffc", "#ffc" } },
                            }
                        },
                        {
                            "B", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#00a08d" } },
                                { "clo", new string[] { "#FFBA32", "#484848", "#4e4e4e", "#fff", "#fff" } },
                                { "head", new string[] { "#ab5f2c" } },
                                { "mouth", new string[] { "#191919", "#191919" } },
                                { "eyes", new string[] { "#000", "#ff23fa63", "#000" } },
                                { "top", new string[] { "#ff90f4", "#ff90f4", "#ff90f4" } },
                            }
                        },
                        {
                            "C", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#22535d" } },
                                { "clo", new string[] { "#000", "#ff2500", "#ff2500", "#fff", "#fff" } },
                                { "head", new string[] { "#a76c44" } },
                                { "mouth", new string[] { "#191919", "#191919" } },
                                { "eyes", new string[] { "#000", "none", "#000" } },
                                { "top", new string[] { "none", "#00efff", "none" } },
                            }
                        },
                    }
                },
                    ...
                    {
                        {
                            "A", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#2668DC" } },
                                { "clo", new string[] { "#2385c6", "#b8d0e0", "#b8d0e0" } },
                                { "head", new string[] { "#ad8a60" } },
                                { "mouth", new string[] { "#000", "#4d4d4d" } },
                                { "eyes", new string[] { "#7fb5a2", "#d1eddf", "#301e19" } },
                                { "top", new string[] { "#fff510", "#fff510" } },
                            }
                        },
                        {
                            "B", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#643869" } },
                                { "clo", new string[] { "#D67D1B", "#b8d0e0", "#b8d0e0" } },
                                { "head", new string[] { "#CC985A", "none0000" } },
                                { "mouth", new string[] { "#000", "#ececec" } },
                                { "eyes", new string[] { "#1f2644", "#9b97ce", "#301e19" } },
                                { "top", new string[] { "#00eaff", "none" } },
                            }
                        },
                        {
                            "C", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#F599FF" } },
                                { "clo", new string[] { "#2823C6", "#b8d0e0", "#b8d0e0" } },
                                { "head", new string[] { "#C7873A" } },
                                { "mouth", new string[] { "#000", "#4d4d4d" } },
                                { "eyes", new string[] { "#581b1b", "#FF8B8B", "#000" } },
                                { "top", new string[] { "none", "#9c0092" } },
                            }
                        },
                    }
                },
                ...
                // Ateam
                {
                    "13", new Dictionary<string, Dictionary<string, string[]>>
                    {
                        {
                            "A", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#d10084" } },
                                { "clo", new string[] { "#efedee", "#00a1e0", "#00a1e0", "#efedee", "#ffce1c" } },
                                { "head", new string[] { "#b35f49" } },
                                { "mouth", new string[] { "#3a484a", "#000" } },
                                { "eyes", new string[] { "#000" } },
                                { "top", new string[] { "#000", "none", "#000", "none" } },
                            }
                        },
                        {
                            "B", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#E6C117" } },
                                { "clo", new string[] { "#efedee", "#ec0033", "#ec0033", "#efedee", "#f2ff05" } },
                                { "head", new string[] { "#ffc016" } },
                                { "mouth", new string[] { "#4a3737", "#000" } },
                                { "eyes", new string[] { "#000" } },
                                { "top", new string[] { "#ffe900", "#ffe900", "none", "#ffe900" } },
                            }
                        },
                        {
                            "C", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#1d8c00" } },
                                { "clo", new string[] { "#e000cb", "#fff", "#fff", "#e000cb", "#ffce1c" } },
                                { "head", new string[] { "#b96438" } },
                                { "mouth", new string[] { "#000", "#000" } },
                                { "eyes", new string[] { "#000" } },
                                { "top", new string[] { "#53ffff", "#53ffff", "none", "none" } },
                            }
                        },
                    }
                },
                ...
                // Rasta
                {
                    "14", new Dictionary<string, Dictionary<string, string[]>>
                    {
                        {
                            "A", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#fc0065" } },
                                { "clo", new string[] { "#708913", "#fdea14", "#708913", "#fdea14", "#708913" } },
                                { "head", new string[] { "#DEA561" } },
                                { "mouth", new string[] { "#444", "#000" } },
                                { "eyes", new string[] { "#000" } },
                                { "top", new string[] { "#32393f", "#32393f", "#32393f", "#32393f", "#32393f", "#32393f", "#32393f", "#32393f", "#32393f", "#32393f", "#32393f", "#32393f", "#32393f", "#32393f", "#32393f", "#32393f", "#32393f" } },
                            }
                        },
                        {
                            "B", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#81f72e" } },
                                { "clo", new string[] { "#ff0000", "#ffc107", "#ff0000", "#ffc107", "#ff0000" } },
                                { "head", new string[] { "#ef9831" } },
                                { "mouth", new string[] { "#6b0000", "#000" } },
                                { "eyes", new string[] { "#000" } },
                                { "top", new string[] { "#FFFAAD", "#FFFAAD", "#FFFAAD", "#FFFAAD", "#FFFAAD", "#FFFAAD", "#FFFAAD", "#FFFAAD", "#FFFAAD", "#FFFAAD", "#FFFAAD", "#FFFAAD", "#FFFAAD", "none", "none", "none", "none" } },
                            }
                        },
                        {
                            "C", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#00D872" } },
                                { "clo", new string[] { "#590D00", "#FD1336", "#590D00", "#FD1336", "#590D00" } },
                                { "head", new string[] { "#c36c00" } },
                                { "mouth", new string[] { "#56442b", "#000" } },
                                { "eyes", new string[] { "#000" } },
                                { "top", new string[] { "#004E4C", "#004E4C", "#004E4C", "#004E4C", "#004E4C", "#004E4C", "#004E4C", "#004E4C", "#004E4C", "none", "none", "none", "none", "none", "none", "none", "none" } },
                            }
                        },
                    }
                },
                    ...
                    {
                        {
                            ...
                            {
                                { "env", new string[] { "#111" } },
                                { "clo", new string[] { "#000", "#00FFFF" } },
                                { "head", new string[] { "#755227" } },
                                { "mouth", new string[] { "#fff", "#000" } },
                                { "eyes", new string[] { "black", "#008a", "aqua" } },
                                { "top", new string[] { "#fff", "#fff", "#fff", "#fff", "#fff" } },
                            }
                        },
                        {
                            "B", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#00D0D4" } },
                                { "clo", new string[] { "#000", "#fff" } },
                                { "head", new string[] { "#755227" } },
                                { "mouth", new string[] { "#fff", "#000" } },
                                { "eyes", new string[] { "black", "#1df7ffa3", "#fcff2c" } },
                                { "top", new string[] { "#fff539", "none", "#fff539", "none", "#fff539" } },
                            }
                        },
                        {
                            "C", new Dictionary<string, string[]>()
                            {
                                { "env", new string[] { "#DC75FF" } },
                                { "clo", new string[] { "#000", "#FFBDEC" } },
                                { "head", new string[] { "#997549" } },
                                { "mouth", new string[] { "#fff", "#000" } },
                                { "eyes", new string[] { "black", "black", "aqua" } },
                                { "top", new string[] { "#00fffd", "none", "none", "none", "none" } },
                            }
                        },
                    }
                },
        ...
        public static string Build(string avatarId, bool scansEnv = false, MultiAvatarOptions? options = null)
        {
            ...
            // Robo
            sP["00"] = new Dictionary<string, string>();
            sP["00"]["env"] = Env;
            ...
            // Girl
            sP["01"] = new Dictionary<string, string>();
            sP["01"]["env"] = Env;
            ...
            // Blonde
            sP["02"] = new Dictionary<string, string>();
            sP["02"]["env"] = Env;
            ...
            // Guy
            sP["03"] = new Dictionary<string, string>();
            sP["03"]["env"] = Env;
            ...
            // Country
            sP["04"] = new Dictionary<string, string>();
            sP["04"]["env"] = Env;
            ...
            // Geeknot
            sP["05"] = new Dictionary<string, string>();
            sP["05"]["env"] = Env;
            ...
            // Asian
            sP["06"] = new Dictionary<string, string>();
            sP["06"]["env"] = Env;
            ...
            // Punk
            sP["07"] = new Dictionary<string, string>();
            sP["07"]["env"] = Env;
            ...
            // Afrohair
            sP["08"] = new Dictionary<string, string>();
            sP["08"]["env"] = Env;
            ...
            // Normie Female
            sP["09"] = new Dictionary<string, string>();
            sP["09"]["env"] = Env;
            ...
            // Older
            sP["10"] = new Dictionary<string, string>();
            sP["10"]["env"] = Env;
            ...
            // Firehair
            sP["11"] = new Dictionary<string, string>();
            sP["11"]["env"] = Env;
            ...
            // Blond
            sP["12"] = new Dictionary<string, string>();
            sP["12"]["env"] = Env;
            ...
            // Ateam
            sP["13"] = new Dictionary<string, string>();
            sP["13"]["env"] = Env;
            ...
            // Rasta
            sP["14"] = new Dictionary<string, string>();
            sP["14"]["env"] = Env;
            ...
            // Meta
            sP["15"] = new Dictionary<string, string>();
            sP["15"]["env"] = Env;
            ...
            var sha256Hash = SHA256EncryptString(avatarId);
            var sha256Numbers = new Regex("[^0-9]").Replace(sha256Hash, string.Empty);
            var hash = sha256Numbers.Substring(0, 12);

            // Parts
            var keys = new string[] { "env", "clo", "head", "mouth", "eyes", "top" };
            var i = 0;
            var final = new Dictionary<string, string>();
            foreach (var part in keys)
            {
                var partV = string.Empty;
                var theme = string.Empty;
                MultiAvatarOptions op;
                if (options == null)
                {
                    op = default(MultiAvatarOptions);
                    var nr = Math.Round((47m / 100m) * Convert.ToDecimal(hash.Substring(i * 2, 2)));
                    ...
                    op.PartV = nr.ToString("0#");
                }
                else
                {
                    op = options.GetValueOrDefault();
                }

                i++;
                final[part] = GetFinal(sP, part, op);
            }
        ...
        {
            var colors = Themes[options.PartV][options.Theme][part];
            var svgString = sp[options.PartV][part];

            var regex = new Regex("#(.*?);");
            var result = regex.Matches(svgString);

            var resultFinal = svgString;
            if (result?.Count > 0)
            {
                var i = 0;
                resultFinal = regex.Replace(resultFinal, o => colors[i++]);
            }

            return resultFinal;
        }

        private static string SHA256EncryptString(string data)
        {
